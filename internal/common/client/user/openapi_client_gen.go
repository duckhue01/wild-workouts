...
type ClientInterface interface {
	...
	GetUserInformation(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetUserInformation(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetUserInformationRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
func NewGetUserInformationRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// GetUserInformation request
	GetUserInformationWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetUserInformationResponse, error)
}
...
func (c *ClientWithResponses) GetUserInformationWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetUserInformationResponse, error) {
	rsp, err := c.GetUserInformation(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
